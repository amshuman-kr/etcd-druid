...
var _ = Describe("setup", func() {
	...
	BeforeEach(func() {
		...
		labelSelector, err = metav1.LabelSelectorAsSelector(instance.Spec.Selector)
	...
	Describe("EtcdCustodian", func() {
		...
		Describe("Reconcile", func() {
			...
			Describe("without any statefulset", func() {
				BeforeEach(func() {
					mockListGetAndUpdateStatefulSet(cl, labelSelector).AnyTimes()
				})
			...
			Describe("with a statefulset", func() {
				...
				BeforeEach(func() {
					...
					mockListGetAndUpdateStatefulSet(cl, labelSelector, sts).AnyTimes()
				})
			...
			Describe("when backup secrets are present", func() {
				...
				Describe("create or update", func() {
					...
					Describe("without services and configmaps", func() {
						...
						BeforeEach(func() {
							mockListGetAndUpdateService(cl, labelSelector).Times(1)
							mockListGetAndUpdateConfigMap(cl, labelSelector).Times(1)
							...
							mockListGetAndUpdateService(cl, labelSelector, svc).AnyTimes().After(
							...
							mockListGetAndUpdateConfigMap(cl, labelSelector, cm).AnyTimes().After(
						...
						Describe("statefulset success", func() {
							...
							Describe("without statefulset", func() {
								...
								BeforeEach(func() {
									mockListGetAndUpdateStatefulSet(cl, labelSelector).Times(1)
									...
									mockListGetAndUpdateStatefulSet(cl, labelSelector, sts).AnyTimes().After(createStatefulSetCall)
								})
								...
								Describe("with cronjob", func() {
									BeforeEach(func() {
										...
										mockListGetAndUpdateCronJob(cl, labelSelector, cj).AnyTimes()
								...
								Describe("without cronjob", func() {
									...
									BeforeEach(func() {
										cj = nil
										mockListGetAndUpdateCronJob(cl, labelSelector).Times(1).After(
											cl.EXPECT().Get(
												gomock.Any(),
									...
									Describe("with backup compaction schedule", func() {
										BeforeEach(func() {
											...
											mockListGetAndUpdateCronJob(cl, labelSelector, cj).AnyTimes().After(
								...
								BeforeEach(func() {
									...
									/*
										patch := client.RawPatch(types.MergePatchType, []byte(fmt.Sprintf(
											`{"metadata":{"annotations":{%q:%q,%q:%q},"ownerReferences":null}}`,
											common.GardenerOwnedBy,
											client.ObjectKeyFromObject(instance).String(),
											common.GardenerOwnerType,
											strings.ToLower(etcdGVK.Kind),
										)))*/
...
func mockListGetAndUpdateStatefulSet(cl *mockclient.MockClient, labelSelector labels.Selector, ss ...*appsv1.StatefulSet) calls {
	var (
		ret       []*gomock.Call
...
func mockListGetAndUpdateService(cl *mockclient.MockClient, labelSelector labels.Selector, ss ...*corev1.Service) calls {
	var (
		ret       []*gomock.Call
...
func mockListGetAndUpdateConfigMap(cl *mockclient.MockClient, labelSelector labels.Selector, cms ...*corev1.ConfigMap) calls {
	var (
		ret       []*gomock.Call
...
func mockListGetAndUpdateCronJob(cl *mockclient.MockClient, labelSelector labels.Selector, cjs ...*batchv1beta1.CronJob) calls {
	var (
		ret       []*gomock.Call
